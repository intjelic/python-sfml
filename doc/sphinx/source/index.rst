...
Currently the reference just lists the available classes and their
members.  For the documentation itself, please see the `SFML 2
documentation <http://sfml-dev.org/documentation/2.0/annotated.htm>`_.
The mapping between SFML and this binding should be fairly easy to
grasp.
