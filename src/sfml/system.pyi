...
class Angle:
    ...
    def __imul__(self, other: Number) -> Angle: ...
    def __itruediv__(self, other: Number) -> Angle: ...
    def __imod__(self, other: Angle) -> Angle: ...
...
def degrees(amount: float) -> Angle: ...
def radians(amount: float) -> Angle: ...
