...
class IpAddress:
    ...
    @classmethod
    def get_local_address(cls) -> IpAddress: ...
    @classmethod
    def get_public_address(cls, timeout: Time | None = None) -> IpAddress: ...
...
class Ftp:
    ...
    def login(self, name: str | None = None, message: str = "") -> FtpResponse: ...
    ...
    def upload(self, localfile: str, remotepath: str, mode: int = ...) -> FtpResponse: ...
    def __getattr__(self, name: str) -> Any: ...
...
class HttpRequest:
    ...
    @property
    def field(self) -> NoReturn: ...
    @field.setter
    def field(self, value: tuple[bytes, bytes]) -> None: ...
    @property
    def method(self) -> NoReturn: ...
    @method.setter
    def method(self, method: int) -> None: ...
    @property
    def uri(self) -> NoReturn: ...
    @uri.setter
    def uri(self, uri: bytes) -> None: ...
    @property
    def http_version(self) -> NoReturn: ...
    @http_version.setter
    def http_version(self, value: tuple[int, int]) -> None: ...
    @property
...
class Http:
    def __init__(self, host: bytes, port: int = 0) -> None: ...
